...
Pro typ akce a typ tance jsem navrhla také comboboxy avšak uživatel může vybrat více možností a pokud je možností více než tři tak se zobrazí pouze prvních pět a zbytek bude zobrazen jako "+X", kde X bude počet zbývajících možností. Po rozkliknutí comboboxu se uživateli zobrazí možnosti které zaškrtl. Tento výběr možností bude na mobilním zařízení implementován tak že vyjede nabídka (podobající se modalu) s možnostmi, které může uživatel zaškrtnout/odškrtnout.
